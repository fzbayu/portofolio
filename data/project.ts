...
export const projects = [
  {
    ...
    features: [
      ...
      "Implementasi Front-end menggunakan Next.js dengan arsitektur komponen yang modular dan reusable.",
    ],
    image: "/project/bfub/1.png",
    images: [
      "/project/bfub/1.png",
      "/project/bfub/2.png",
      "/project/bfub/3.png",
    ...
    link: "https://bfub.org",
    figma: "https://www.figma.com/proto/HcnkMWalQUBtC1EfT1AEoi/BFUB-XXVII?node-id=23-64&t=LrnvgKlrAntkxc1g-1"
  },
  {
    ...
    features: [
      ...
      "Implementasi sistem navigasi intuitif yang disesuaikan untuk target pengguna lansia dan keluarga pasien",
      "Perancangan alur pemesanan layanan home visit yang ringkas untuk meningkatkan efisiensi pendaftaran pasien",
      "Transformasi identitas visual menjadi lebih profesional dan terpercaya guna memperkuat branding layanan medis",
      "Optimasi tata letak informasi wilayah cakupan Jabodetabek agar lebih komunikatif dan mudah dipahami"
    ],
    image: "/project/fisiopro/1.png",
    images: [
      "/project/fisiopro/1.png",
      "/project/fisiopro/2.png",
      "/project/fisiopro/3.png",
      "/project/fisiopro/4.png",
      "/project/fisiopro/5.png",
      "/project/fisiopro/6.png",
    ],
    link: "https://fisiopro.id/",
    figma: "https://www.figma.com/proto/TS8qjTLhNHYcnESUQsH17N/FisioPro?node-id=1-2&t=rxhiXjlpmfVYv1aG-1"
  },
  {
    ...
    features: [
      ...
      "Sistem tata letak kebun berbasis grid interaktif dengan fungsionalitas kustomisasi ruang.",
      "Implementasi Front-End responsif menggunakan Next.js untuk pengalaman pengguna yang mulus.",
      "Fitur pemantauan komprehensif: Panduan perawatan, pengingat aktivitas, dan jurnal pertumbuhan tanaman.",
      "Visualisasi progres pertanian yang memudahkan dokumentasi siklus hidup tanaman secara digital."
    ],
    image: "/project/lantaihijau/1.png",
    images: [
      "/project/lantaihijau/1.png",
      "/project/lantaihijau/2.png",
      "/project/lantaihijau/3.png",
      "/project/lantaihijau/4.png",
      "/project/lantaihijau/5.png",
      "/project/lantaihijau/6.png",
      "/project/lantaihijau/7.png",
      "/project/lantaihijau/8.png",
    ],
    github: "https://github.com/rbdmn/LantaiHijau_SECOMP2025.git",
    figma: "https://www.figma.com/proto/SzI9BwvRrZllzqLhvZBW97/LantaiHijau?node-id=132-3390&t=6YrWrCbocMD20gOk-1",
  },
  {
    ...
    features: [
      ...
      "Struktur navigasi linear yang sederhana untuk memastikan tingkat penyelesaian kuesioner yang tinggi.",
      "Desain antarmuka yang bersih dan nyaman guna meningkatkan fokus pengguna saat menjawab pertanyaan.",
      "Visualisasi hasil kuesioner yang komunikatif untuk merefleksikan preferensi film pengguna secara personal.",
      "Optimasi tata letak elemen visual untuk menciptakan pengalaman pengisian data yang tidak membosankan."
    ],
    image: "/project/detikbahagia/1.png",
    images: [
      "/project/detikbahagia/1.png",
  ...
  },
  {
    ...
    features: [
      ...
      "Penyusunan Information Architecture yang terstruktur untuk navigasi pendaftaran peserta lintas jenjang pendidikan.",
      "Antarmuka Ujian Minimalis: Desain ruang ujian yang bersih dan bebas gangguan untuk memaksimalkan fokus siswa saat mengerjakan soal.",
    ],
    image: "/project/phyfest/1.png",
    images: [
      "/project/phyfest/1.png",
      "/project/phyfest/2.png",
      "/project/phyfest/3.png",
      "/project/phyfest/4.png",
    ],
    figma: "https://www.figma.com/proto/PT0VtlkB2rh5gyZOLm8uix/PhysicsFest?node-id=33-174&t=rxhiXjlpmfVYv1aG-1"
  },
  {
    ...
    features: [
      ...
      "Sistem Manajemen Sirkulasi: Alur digital untuk proses peminjaman, pengambilan, dan pengembalian alat yang terorganisir.",
      "Implementasi Front-End responsif untuk memudahkan mahasiswa melakukan reservasi alat melalui berbagai perangkat.",
      "Fitur Pelacakan Aset: Pendataan inventaris berbasis kategori untuk mempercepat pencarian peralatan laboratorium.",
      "Dashboard Monitoring Admin: Visualisasi data stok dan riwayat peminjaman untuk efisiensi manajemen gudang."
    ],
    image: "/project/deviota/1.png",
    images: [
      "/project/deviota/1.png",
      "/project/deviota/2.png",
      "/project/deviota/3.png",
      "/project/deviota/4.png",
      "/project/deviota/5.png"
    ],
    figma: "https://www.figma.com/proto/z2VkYitDhZ4UtENEmEliae/MOCKUP-UI-DEVIOTA?node-id=476-872&t=7kbLhQSLZSpKvUmG-1"
  },
  {
    ...
    features: [
      ...
      "Desain Dashboard Siswa dengan visualisasi kontribusi ala GitHub",
      "Perancangan antarmuka Smart Kanban Board untuk kolaborasi tim",
      "Interface khusus Monitoring Guru untuk pemantauan progres kelompok",
      "Desain sistem repositori dokumen dan ruang diskusi interaktif"
    ],
    image: "/project/saka/1.png", // Sesuaikan dengan path aset Anda
    images: [
      "/project/saka/1.png",
      "/project/saka/2.png",
      "/project/saka/3.png",
      "/project/saka/4.png",
      "/project/saka/5.png",
      "/project/saka/figma.png",
    ],
    figma: "https://www.figma.com/proto/HwZJhiE4I6jNBCu9Vn8zB0/SAKA---DIMASTI?node-id=25-6&t=PMfGNkGkye7psxh7-1",
  },
  {
    ...
    features: [
      ...
      "Optimalisasi Mapping & Feedback untuk status antrean pasien secara real-time",
      "Penerapan Constraints untuk meminimalisir kesalahan input data medis",
      "Desain antarmuka inklusif berdasarkan model mental mahasiswa dan staf UPI",
      "High-fidelity prototype dengan transisi yang intuitif dan konsisten"
    ],
    image: "/project/kesehatanupi/1.png", // Sesuaikan dengan path aset Anda
    images: [
      "/project/kesehatanupi/1.png",
      "/project/kesehatanupi/2.png",
      "/project/kesehatanupi/3.png",
      "/project/kesehatanupi/4.png",
      "/project/kesehatanupi/5.png",
    ],
